 ...
 *
 * Returns:
 *   1 (true) if x and y have the same sign bit, 0 (false) otherwise.
 */
 ...
 *   Rating: 3
 */
unsigned reverse(unsigned v){ // 32-bit word to reverse bit order
   return 2;
}
/* 
 ...
 *   Legal ops: Bitwise operations and shifting are allowed.
 *   Max ops: N/A
 *   Rating: 3
 */
