...
{"byteSwap", (funct_t) byteSwap, (funct_t) test_byteSwap, 3,
 ...
 {"leftBitCount", (funct_t) leftBitCount, (funct_t) test_leftBitCount, 1, "! ~ & ^ | + << >>,<,>", 40, 4,
  ...
  {"samesign",(funct_t)samesign,(funct_t)test_samesign,2,">> ! ^",5,2,{{TMin, TMax},{TMin,TMax},{TMin,TMax}}},
  {"logtwo",(funct_t) logtwo,(funct_t) test_logtwo,1,"$",25,4,{{0, TMax},{TMin,TMax},{TMin,TMax}}},
